package zone.potion.utils.message;
...
public class Messages {
    ...
    public static final String DISCORD_LINK = "discord.me/patrone";
    public static final String[] FROZEN_MESSAGE = {
            "&c&m------------------------------",
            "&4You have been frozen.",
            "&c&m------------------------------",
            "&4To prove your innocence, join a support channel in:",
            "&e" + DISCORD_LINK
    };
    private static final String APPEAL_MESSAGE = CC.GRAY + "\nIf you believe this was a false ban, you can appeal it at "
            + CC.YELLOW + "http://appeal.patrone.cc" + CC.GRAY + " or buy an unban at " + CC.YELLOW + "store.patrone.cc" + CC.GRAY + ".";
